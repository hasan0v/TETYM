      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="text-2xl font-bold bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 text-transparent bg-clip-text">SSTCC</div>
            <p className="text-sm text-gray-300">
              Bakı Dövlət Universiteti<br />
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li>Z. Xəlilov küç. 23, Bakı, Azərbaycan</li>
              <li>23 Z. Khalilov St., Baku, Azerbaijan</li>
              <li>info@sstcc.bsu.edu.az</li>
              <li>+994 12 123 4567</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 md:flex md:items-center md:justify-between">
          <div className="text-sm text-gray-400">
            © {new Date().getFullYear()} BSU SSTCC. All rights reserved.
          </div>
